...
const HTMLHead = ({ title, locale, post = '', page = '' }) => (
    <Head>
        ...
        <meta name="twitter:image" content={post ? brand.cboard.fullUrl + post.image : brand.cboard.img} />
        ...
        <meta property="og:image" itemProp='image' content={post ? brand.cboard.fullUrl + post.image : brand.cboard.img} />
